...
export default function ImgsExplicationSolidWorks() {
    const testimonialsData = [
        ...
        },
        {
            ...
            author: "Joaquín Metral",
            position: "Cliente",
            image: "/Lagerstuck_2500167-161810.01_a-confidential.jpg",
        },
        {
            id: 6,
            ...
            author: "Joaquín Metral",
            position: "Cliente",
            image: "/Verteilergehause_2300002-202110.001-confidential.jpg",
        },
        {
            id: 1,
    ...
    return (
        <section className="relative gowun-batang-regular flex flex-col items-center pt-[5rem]">
            ...
            <div className="relative flex flex-col items-center w-full px-6 mx-auto">
                <img
                    className="object-cover object-center w-full lg:w-[80%] rounded-lg h-[43rem]"
