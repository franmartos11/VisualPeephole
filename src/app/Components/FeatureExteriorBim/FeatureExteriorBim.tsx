            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="w-full sm:w-1/2 mb-4 px-2 ">
                        ...
                        <div className="h-full py-4 px-6 border border-gray-500 border-t-0 border-l-0 rounded-br-xl">
                            <h3 className="text-2xl font-bold text-md mb-6">High quality models</h3>
                            <p className="text-sm">With years of experience in creating accurate models, we bring unparalleled expertise to your project, ensuring high quality results.</p>
                        </div>
                    </div>
